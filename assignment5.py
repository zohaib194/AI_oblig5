...
class CSP:
    ...
    def backtrack(self, assignment):
        ...
        ## Get name for unassigned variable.
        name = self.select_unassigned_variable(assignment)

        ## Found solution.
        if name == None :
            return assignment           ## Yes return solution.

        
        ## Loop through the domains values of unassigned variable
        for value in assignment[name] :
